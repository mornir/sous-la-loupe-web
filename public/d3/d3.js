!(function () {
  ...
  d3.median = function (array, f) {
    ...
    return numbers.length
      ? d3.quantile(numbers.sort(d3_ascending), 0.5)
      : undefined
  }
  ...
  d3.selectAll = function (nodes) {
    var group = d3_array(
      typeof nodes === 'string' ? d3_selectAll(nodes, d3_document) : nodes
    )
    group.parentNode = d3_documentElement
    return d3_selection([group])
  }
  ...
  d3.behavior.zoom = function () {
    ...
    function dblclicked() {
      ...
      zoomstarted(dispatch)
      scaleTo(
        Math.pow(2, d3.event.shiftKey ? Math.ceil(k) - 1 : Math.floor(k) + 1)
      )
      translateTo(p, l)
      zoomed(dispatch)
      zoomended(dispatch)
  ...
  function d3_interpolateString(a, b) {
    var bi =
        (d3_interpolate_numberA.lastIndex =
        d3_interpolate_numberB.lastIndex =
          0),
      am,
      bm,
      bs,
  ...
  var d3_category20 = [
    ...
    16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711,
  ...
  var d3_category20c = [
    ...
    16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372,
  ...
  function d3_transition_tween(groups, name, value, tween) {
    ...
    return d3_selection_each(
      ...
      typeof value === 'function'
        ? function (node, i, j) {
            node.__transition__[id].tween.set(
              name,
  ...
  d3_transitionPrototype.styleTween = function (name, tween, priority) {
    ...
    function styleTween(d, i) {
      var f = tween.call(
        ...
        d,
        i,
        d3_window.getComputedStyle(this, null).getPropertyValue(name)
      )
      return (
        f &&
        function (t) {
  ...
  d3_transitionPrototype.delay = function (value) {
    ...
    return d3_selection_each(
      ...
      typeof value === 'function'
        ? function (node, i, j) {
            node.__transition__[id].delay = +value.call(
              node,
              node.__data__,
              i,
              j
  ...
  d3_transitionPrototype.duration = function (value) {
    ...
    return d3_selection_each(
      ...
      typeof value === 'function'
        ? function (node, i, j) {
            node.__transition__[id].duration = Math.max(
              1,
  ...
  d3_transitionPrototype.each = function (type, listener) {
    ...
    if (arguments.length < 2) {
      ...
      d3_selection_each(this, function (node) {
        ...
        ;(
          transition.event || (transition.event = d3.dispatch('start', 'end'))
        ).on(type, listener)
      })
    }
    return this
